...
export const VectorMessage = ({ data }) => {
  const [vectorData, setVectorData] = useState(data);
  const { _id, orderStatus, email, readStatus, vector } = vectorData;
  const [uploadFiles, setUploadFiles] = useState(vector.completeOrder);
            ...
            <dl>
              ...
              <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd className="mt-1 text-sm text-gray-900 space-x-6 sm:mt-0 sm:col-span-2">
                  <span>Height : {vector.designSize.height}</span>
                  <span className="font-bold">X</span>
                  <span>Width : {vector.designSize.width}</span>
                </dd>
              </div>
              {/* Design Category */}
              <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
